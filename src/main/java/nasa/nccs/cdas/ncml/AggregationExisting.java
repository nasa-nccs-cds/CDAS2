 ...
 * @author caron
 */
public class AggregationExisting extends nasa.nccs.cdas.ncml.AggregationOuterDimension {

    public AggregationExisting(NetcdfDataset ncd, String dimName, String recheckS) {
        super(ncd, dimName, nasa.nccs.cdas.ncml.Aggregation.Type.joinExisting, recheckS);
    }
    ...
    protected void buildNetcdfDataset(CancelTask cancelTask) throws IOException {
        ...
        if (type != nasa.nccs.cdas.ncml.Aggregation.Type.joinExistingOne) {
        ...
        for (Variable v : typical.getVariables()) {
            ...
            boolean matches = (outerName != null) && ( dimName.equals(outerName) || dimName.split(":")[0].equals(outerName.split(":")[0]) );
            if ( !matches )
                continue;
