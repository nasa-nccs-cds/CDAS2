...
class StdKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        ...
        return CDArray.createResult( task, input, result )
...
class MaxKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.max( self.getAxes(task) ) )
...
class MinKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.min( self.getAxes(task) ) )
...
class MeanKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.mean( self.getAxes(task) ) )

class SumKernel(Kernel):
    def __init__( self ):
        Kernel.__init__( self, KernelSpec("sum", "Sum","Computes the sum of the array elements along the given axes.") )
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.sum( self.getAxes(task) ) )
...
class PtpKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.ptp( self.getAxes(task) ) )
...
class VarKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return CDArray.createResult( task, input, input.array.var( self.getAxes(task) ) )
