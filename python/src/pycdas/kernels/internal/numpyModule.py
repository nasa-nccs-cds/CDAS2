...
class StdKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        result = input.array.std( self.getAxes(task.metadata), None, None, True )
...
class MaxKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return npArray.createResult( task, input, input.array.max( self.getAxes(task.metadata), None, None, True ) )
...
class MinKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return npArray.createResult( task, input, input.array.min( self.getAxes(task.metadata), None, None, True ) )
...
class MeanKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return npArray.createResult( task, input, input.array.mean( self.getAxes(task.metadata), None, None, True ) )
...
class SumKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        ...
        return npArray.createResult( task, input, input.array.sum( self.getAxes(task.metadata), None, None, True ) )
...
class PtpKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return npArray.createResult( task, input, input.array.ptp( self.getAxes(task.metadata), None, None, True ) )
...
class VarKernel(Kernel):
    ...
    def executeOperation( self, task, input ):
        return npArray.createResult( task, input, input.array.var( self.getAxes(task.metadata), None, None, True ) )
