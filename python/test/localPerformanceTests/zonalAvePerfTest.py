...
#    datainputs = '[domain=[{"name":"d0"},"time":{"start":0,"end":36,"system":"indices"}],variable=[{"uri":"' + cldraMERRAdset + '","name":"'+merraVar+':v1","domain":"d0"}],operation=[{"name":"python.numpyModule.ave","input":"v1","axes":"xt"}]]'
