...
try:
    ...
    t0 = time.time()
    datainputs = '[domain=[{"name":"d0","lev":{"start":0,"end":12,"system":"indices"}}],variable=[{"uri":"' + cldraMERRAdset + '","name":"'+merraVar+':v1","domain":"d0"}],operation=[{"name":"CDSpark.average","input":"v1","axes":"t"}]]'
