...
#    datainputs = """[domain=[{"name":"d0","lev":{"start":10,"end":10,"system":"indices"}}],variable=[{"uri":"collection:/npana","name":"tas:v1","domain":"d0"}],operation=[{"name":"numpyModule.max","input":"v1","axes":"tx"}]]"""
    datainputs = """[domain=[{"name":"d0","time":{"start":0,"end":1000,"system":"indices"}}],variable=[{"uri":"file://att/gpfsfs/ffs2004/ppl/tpmaxwel/cdas/cache/collections/NCML/npana.xml","name":"T:v1","domain":"d0"}],operation=[{"name":"python.cdmsModule.AverageKernel","input":"v1","domain":"d0","axes":"tz"}]]"""
